...
(() => {
/*!*********************************!*\
  !*** ./resources/js/trabajo.js ***!
  \*********************************/
var _require = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"),
    result = _require.result;

var token = document.getElementsByTagName('meta')[3].content;

window.trabajo = function trabajo() {
  var s = 0;
  var url = '/test';
  var nro_l = 0;
  var producto = document.getElementById('product_name').textContent;
  var lineas = document.getElementsByClassName('form-check-input');
  var nombre = document.getElementById('nombreApellido').textContent;
  ...
  if (producto && nombre && s) {
    ...
    var label_trabajo = document.getElementById('trabajo').innerText;
...
window.retrabajo = function retrabajo() {
  ...
  if (producto && nombre && s) {
    ...
    var label_retrabajo = document.getElementById('reTrabajo').innerText;
...
window.cod_fun = function cod_fun() {
  var select_cod = document.getElementById('select_cod');
  var option_id = document.getElementById(select_cod.value);
...
input_cod.addEventListener('keyup', function () {
  var label_funcionario = document.getElementById('nombreApellido');
  var input_cod = document.getElementById("autocomplete");
...
input_prod.addEventListener('keyup', function () {
  var label_producto = document.getElementById('product_name');
  var input_prod = document.getElementById("autocompleteproduc");
  var key = event.keyCode || event.charCode;
